...
// ==/ClosureCompiler==
// hidden: https://github.com/googlemaps/js-marker-clusterer/pull/33/files
/**
...
function MarkerClusterer(map, opt_markers, opt_options) {
  ...
  this.sizes = [90, 90, 90, 90, 90, 90, 90, 90, 90, 90];
...
ClusterIcon.prototype.onAdd = function() {
 // vlada - hide cluster when each marker has visible = false
...
ClusterIcon.prototype.createCss = function(pos) {
  ...
  style.push('cursor:pointer; top:' + pos.y + 'px; left:' +
      ...
      txtSize + 'px; font-family:Roboto,Arial,sans-serif;');
  return style.join('');
};
