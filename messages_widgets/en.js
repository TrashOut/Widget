 	 ...
 	 if (lng === 'en' ) { 
 	 	 i18n.translator.add({ 
 	 	 	 values: {
	 	 	 	...
	 	 	 	"global.menu.collectionPoints": "Recycling Points",
	 	 	 	...
	 	 	 	"global.aboutProject": "TrashOut is an environmental project which aims to map and monitor all illegal dumps all around the world.\n\nOur effort is to involve citizens, governments, municipalities and organizations so we can together contribute to cleaner world for everyone. \n\nThank You for joining TrashOut environmental community and keeping it running.",
	 	 	 	...
	 	 	 	"trash.status.cleaned": "It`s cleaned",
	 	 	 	...
	 	 	 	"global.loadingError": "Loading failed",
	 	 	 	...
	 	 	 	"home.nearestRecyclingPoints": "Nearest recycling points",
	 	 	 	"collectionPoint.size.recyclingBin": "Bin",
	 	 	 	"collectionPoint.size.recyclingCenter": "Center",
	 	 	 	"collectionPoint.size.all": "All",
	 	 	 	"collectionPoint.header": "Recycling Points",
	 	 	 	"collectionPoint.list.header": "Recycling Point List",
	 	 	 	"collectionPoint.create.header": "Create Recycling Point",
	 	 	 	"collectionPoint.edit.header": "Edit Recycling Point",
	 	 	 	...
	 	 	 	"collectionPoint.location": "Address of recycling point",
	 	 	 	"collectionPoint.size": "Size of Recycling Point",
	 	 	 	"collectionPoint.type": "Recycling point type",
	 	 	 	"home.recentActivity.header": "Recent Activity",
	 	 	 	"home.recentActivity.noActivity": "No recent activity.",
	 	 	 	"events.header": "Events",
	 	 	 	"home.events.text": "Upcoming events in your neighbourhood",
	 	 	 	...
	 	 	 	"trash.accessibility.underWater": "Located under water",
	 	 	 	...
	 	 	 	"event.whatBringFull": "What attendees need to bring (e.g.: Shovel, water...)",
	 	 	 	...
	 	 	 	"event.create.youSelectedDumps_X": "You have selected {number} dumps",
	 	 	 	...
	 	 	 	"event.header_X": "Cleaning event: {string}",
	 	 	 	...
	 	 	 	"collectionPoint.other": "More recycling points around you",
	 	 	 	"global.filter.noResult": "No results, change filter options",
	 	 	 	"collectionPoint.filter.header": "Recycling point filter",
	 	 	 	"trash.filter.header": "Trash Filter",
	 	 	 	"global.filter": "Filter",
	 	 	 	"collectionPoint.filter.size": "Dispose Size",
	 	 	 	"collectionPoint.filter.types": "Dispose Types",
	 	 	 	...
	 	 	 	"profile.earnedPoints_X": "You have earned {number} points so far! Update more dumps to receive more. Thank you!",
	 	 	 	"profile.points_X": "{number} points",
	 	 	 	...
	 	 	 	"trash.illegalDumpIn_X": "Illegal Dump in {string}",
	 	 	 	"trash.reportedDetailsonWeb_X": "Illegal dump was reported! Details about illegal dump can be found on website: {string}",
	 	 	 	...
	 	 	 	"trash.foundDumps_X": "Found dumps: {number}",
	 	 	 	...
	 	 	 	"collectionPoint.types.eletronic": "electronic",
	 	 	 	...
	 	 	 	"collectionPoint.filter.ids": "Recycling Points IDs",
	 	 	 	...
	 	 	 	"notifications.reportedCollectionPoints": "Reported Recycling Points",
	 	 	 	...
	 	 	 	"event.confirmation.joinEvent": "Do you really want to join event?",
	 	 	 	...
	 	 	 	"trash.detail.reportToMunicipality": "Send by e-mail",
	 	 	 	...
	 	 	 	"trash.edit.minPhotosText": "To create or update trash you have to take at least {number} photo",
	 	 	 	"trash.validation.mustSelectMeetingPoint": "You must first choose the position of meeting",
	 	 	 	"event.detail.bring": "Bring",
	 	 	 	"event.detail.pleaseBring": "Please bring",
	 	 	 	"global.cropImage": "Crop Image",
	 	 	 	"collectionPoint.disposeTypes": "Dispose Types",
	 	 	 	...
	 	 	 	"collectionPoint.create.images": "Please select Image or Logo of Recycling Point. It's not necessary, but it helps others to find the place easier. ",
	 	 	 	...
	 	 	 	"collectionPoint.update.success": "Recycling point was successfully updated.",
	 	 	 	...
	 	 	 	"collectionPoint.delete.confirmation": "Do you really want to delete this Recycling Point?",
	 	 	 	"collectionPoint.detail.header": "Recycling Point Detail",
	 	 	 	"collectionPoint.create.success": "Recycling point was successfully created.",
	 	 	 	...
	 	 	 	"organization.mailSubject": "Mail Subject",
	 	 	 	"organization.mailBody": "Mail Body",
	 	 	 	...
	 	 	 	"collectionPoint.gpsLocation": "Recycling point GPS",
	 	 	 	"collectionPoint.gpsMap": "Recycling point on map",
	 	 	 	...
	 	 	 	"collectionPoint.remove.success": "Recycling point was successfully removed.",
	 	 	 	"collectionPoint.markedAsSpam.alreadyMarked": "This Recycling Point is already marked as SPAM.",
	 	 	 	...
	 	 	 	"event.detail.collectionPoints": "Recycling Points",
	 	 	 	...
	 	 	 	"event.create.collectionPoints": "Recycling Points in area",
				...
				"user.widget.trashMapInit": "Click to view the TrashMap",
	 	 	 	...
	 	 	 	"mail.eventCreate.eventConfirmation": "Please know that one day before your event we will ask people who joined to confirm their attendance. You can check it on event detail in section “joined users”. One day after event we will ask for their guess of how many people came",
	 	 	 	...
	 	 	 	"mail.eventFeedback.eventFeedback3": "Let others know how successful your were. Fill in number of attendees",
	 	 	 	...
	 	 	 	"user.google.hint": "Google+ hint",
	 	 	 	"global.phone.hint": "Phone hint",
	 	 	 	"profile.currentPassword": "Current Password",
	 	 	 	"user.addToArea.success": "Area was successfully added",
	 	 	 	"collectionPoint.created.success": "Recycling point was successfully created",
	 	 	 	"collectionPoint.markedAsSpam.success": "Recycling point was successfully marked as spam.",
	 	 	 	"collectionPoint.removed.success": "Recycling point was successfully removed",
	 	 	 	...
	 	 	 	"global.trashoutShareDescription": "TrashOut is an environmental project which aims to map all illegal dumps all around the world and to help citizens to recycle more.",
	 	 	 	...
	 	 	 	"info.aboutApp": "TrashOut is an environmental project which aims to map and monitor all illegal dumps all around the world.\n\nOur effort is to involve citizens, governments, municipalities and organizations so we can together contribute to cleaner world for everyone.",
	 	 	 	...
	 	 	 	"mail.newsletter.subject": "TrashOut - there is new activity in area you are monitoring",
